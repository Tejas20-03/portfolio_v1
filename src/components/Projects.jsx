...
import img from "../assets/walletwise.png";
...
const Projects = () => {
  ...
  const imageUrls = [
    {
      name: "walletwise",
      img: img,
      link: "https://walletwise-pink.vercel.app/",
    },
    {
      name: "glog",
      img: img2,
  ...
  const [activeSection, setActiveSection] = useState("walletwise");
  ...
  const imgtodiplay = () => {
    const foundElement = imageUrls.find(
      (element) => element.name === activeSection
    );
  ...
  return (
    <div className=" p-20 flex flex-col gap-10 mt-20 sm:p-10">
        ...
        >
          ...
          >
            <Fade triggerOnce direction="up" className="h-screen flex ">
              <div>
                <h1 className="text-5xl font-bold sm:text-3xl">WalletWise</h1>
                <h1 className="text-xl mt-10">
                  A robust web application to efficiently manage personal
              ...
              <div className="grid sm:grid-cols-1 grid-cols-2 gap-8 w-full place-content-around">
                ...
                <div className="text-2xl font-semibold">
                  ...
                  <ul className="mt-6 text-lg list-disc">
                    ...
                    <li>Dashboard with graph integration</li>
                    <li>Easy to use</li>
                    <li>User-Friendly</li>
                  </ul>
                </div>
              ...
              <div className="flex text-xl gap-10 mt-auto">
                <a
                  ...
                  href="https://walletwise-pink.vercel.app/"
                >
                  Live
                </a>
                <a
                  target="_blank"
                  className="hover:underline"
                  href="https://github.com/Tejas20-03/Walletwise"
                >
                  Github Repositary
                </a>
              </div>
            ...
            <Fade triggerOnce direction="up" className="h-screen flex">
              ...
              <div className="flex text-xl gap-10 mt-auto">
                ...
                <a
                  target="_blank"
                  className="hover:underline"
                  href="https://github.com/Tejas20-03"
                >
                  Github Repositary
                </a>
              </div>
      ...
      <Fade triggerOnce direction="up" delay={500} className="ml-auto">
        ...
        >
          <a href="https://github.com/Tejas20-03" target="_blank">
            See More
          </a>
        </button>
      </Fade>
