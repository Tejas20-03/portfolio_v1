    ...
    <div className="px-20 my-10 sm:px-10">
        ...
        <div className="flex flex-1 flex-col gap-12 sm:gap-6">
          ...
          <Fade triggerOnce direction="up">
            <Lottie
              ...
              className="w-1/2 mx-auto brightness-125"
            />
          </Fade>
        </div>
      ...
      >
        <Fade cascade damping={0.2} triggerOnce delay={200} direction="up">
          <a
            href="
            https://www.linkedin.com/in/tejas20/"
            target="_blank"
          >
            <img
              src={link}
          ...
          <a
            href="
            https://www.instagram.com/teeee_seee/"
            target="_blank"
          >
            <img
              src={insta}
          ...
          <a
            href="
              ...
              https://www.github.com/Tejas20-03"
            target="_blank"
          >
            <img
              src={github}
          ...
          <a href="https://www.twitter.com/peproni20" target="_blank">
            <img
              src={x}
              alt="x"
              className="sm:w-7 w-9 aspect-square hover:-translate-y-1 transition-all duration-300 ease-in-out"
